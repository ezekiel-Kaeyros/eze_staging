...
export declare function getNamedExport(filePkg: ParsedFilePkg, name: string, resolveExport?: boolean): ts.Declaration | ts.Expression | undefined;
export declare function getDefaultExport(filePkg: ParsedFilePkg, resolveExport?: boolean): ts.Declaration | ts.Expression | undefined;
export declare function hasExportName(filePkg: ParsedFilePkg, name: string): boolean;
export declare function getStaticName(filePkg: ParsedFilePkg, target: ts.Declaration | ts.Expression, name: string): ts.Symbol | undefined;
export declare function hasStaticName(filePkg: ParsedFilePkg, target: ts.Declaration | ts.Expression, name: string): boolean;
...
export declare function isInsideAppDir(path: string, appFolder: string, pagesFolder: string): boolean;
