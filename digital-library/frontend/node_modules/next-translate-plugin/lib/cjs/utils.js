...
function isInsideAppDir(path, appFolder, pagesFolder) {
    var appIndex = path.indexOf(appFolder);
    var pagesIndex = path.indexOf(pagesFolder);
    if (appIndex === -1)
        return false;
    if (appIndex > -1 && pagesIndex === -1)
        return true;
    return appIndex < pagesIndex;
}
exports.isInsideAppDir = isInsideAppDir;
