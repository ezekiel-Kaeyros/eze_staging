...
//       <AnimateClick>
//         <div className="flex  items-center space-x-2" onClick={() => setToggle((prev) => !prev)}>
...
//                 {locale === 'en' ? (
//                   <div onClick={() => setToggle(false)} className="flex items-center hover:text-primaryColor w-full">
//                     <div className={`${pathName?.split('/')[1] === 'en' ? ' font-bold flex' : 'flex'}`}>EN</div>
//                   </div>
//                 ) : (
//                   <div onClick={() => setToggle(false)} className="flex w-full hover:text-primaryColor">
//                     <div className={`${pathName?.split('/')[1] === 'fr' ? ' font-bold ' : 'flex  '}`}>FR</div>
//                   </div>
//                 )}
//               </Link>
//             </AnimateClick>
